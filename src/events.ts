export enum LampixEvents {
  ...
  WatcherChannelUpdated = 'lx/watcher-channel-updated'
}
...
export const eventToCallbackMap = {
  ...
  [LampixEvents.HttpRequest]: 'onHttpRequest',
  ...
  [LampixEvents.WatcherChannelUpdated]: 'onWatcherChannelUpdated'
};
